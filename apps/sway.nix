...

{
  wayland.windowManager.sway = {
    ...
    extraConfig = ''
      ...
      for_window [app_id="blueman-manager"] floating enable, floating_maximum_size 800 x 600
      ...
      for_window [window_role="pop-up"] floating enable, floating_maximum_size 800 x 600
